            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="../central_admin/central_adm.php">Central Jarvis</a>
                            </li>
                            <li class="active">
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="textinput" name="textinput" type="text" placeholder="Digite seu sobrenome" class="form-control input-md" required="">
